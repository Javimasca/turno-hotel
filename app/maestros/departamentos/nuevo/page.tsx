    ...
    <main className="page-shell">
      ...
      <section className="card">
        {workplaces.length === 0 ? (
          ...
          <form className="form-grid" action="/api/maestros/departamentos" method="post">
            ...
            <div className="form-field">
              ...
              <input id="code" name="code" type="text" placeholder="Ej. REST" required />
            </div>
            ...
            <div className="form-actions">
              <Link href="/maestros/departamentos" className="button button-secondary">
                Cancelar
              </Link>
